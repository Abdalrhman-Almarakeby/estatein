...
const propertiesFiltersSchema = z.object({
  location: z
...
type PropertiesFilters = z.infer<typeof propertiesFiltersSchema>;

export { propertiesFiltersSchema, type PropertiesFilters };
